...
def plot_pivot_points(close, pivot_points):
    ...
    plt.plot(
        pivot_points.index, pivot_points["S1"], label="S1", linestyle="--", color="red"
    )
    plt.plot(
        pivot_points.index,
        pivot_points["R2"],
    ...
    plt.plot(
        pivot_points.index, pivot_points["S2"], label="S2", linestyle="--", color="red"
    )
    plt.plot(
        pivot_points.index,
        pivot_points["R3"],
    ...
    plt.plot(
        pivot_points.index, pivot_points["S3"], label="S3", linestyle="--", color="red"
    )
